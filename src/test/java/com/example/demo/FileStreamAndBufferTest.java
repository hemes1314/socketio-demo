...
public class FileStreamAndBufferTest {

    public static void main(String[] args) {
        // 4GB的数据
        File sourceFile = new File("d://Bert_txt_classification_TrainEval.zip");
        File targetFile = new File("d://d2.iso");
        ...
        // stream方式
       // FileStreamAndBufferTest.copyFileByStream(sourceFile, targetFile);

        // channel方式
        FileStreamAndBufferTest.copyFileByFileChannel(sourceFile, targetFile);
    }
